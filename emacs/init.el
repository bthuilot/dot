...
(custom-set-variables
 ...
 '(package-selected-packages
   '(highlight-parentheses company fira-code-mode flycheck sml-mode lsp-ui lsp-mode lsp-haskell projectile all-the-icons haskell-mode dashboard go-complete gruvbox-theme)))
(custom-set-faces
